...
class DatabaseHelper {
  ...
  Future<Database> initializeDatabase() async {
    ...
    String path = directory.path + 'myTodo.db';
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE $todoTable($colId INTEGER PRIMARY KEY AUTOINCREMENT, $colTitle TEXT, $colDate TEXT)');
  }
  ...
  Future<int> updateTodo(Todo todo) async {
    ...
    int result = await db.update(todoTable, todo.toMap(), where: '$colId');
    return result;
  }
